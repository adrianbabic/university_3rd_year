...
public class ArrayIndexedCollectionTest {
	...
	private ArrayIndexedCollection<Integer> example;
	...
	public void testChoosingSize() {
		...
		example.add(4);
		example.add(5);
		ArrayIndexedCollection<Integer> toTest = new ArrayIndexedCollection<>(example,4);
	...
	public void testCopyingCollection() {
		...
		example.add(4);
		example.add(5);
		ArrayIndexedCollection<Integer> toTest = new ArrayIndexedCollection<>(example);
		assertEquals(5, toTest.toArray().length);
		assertEquals(5, toTest.size());
	}
	...
	public void testInsertWrongIndex() {
		...
		example.add(2);
		example.add(3);
		assertThrows(IndexOutOfBoundsException.class, () -> example.insert(5, 4));
	}
