	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			for(int i = 0; i < args.length; i++) {
				...
				throw new IllegalArgumentException("Invalid argument(s). Supported arguments are in form of: --workers=N,\n"
						+ " -w N, --tracks=K, -t K. Each argument should be entered at most once.");
			}
...
//			Mandelbrot.calculate(reMin, reMax, imMin, imMax, width, height, m, yMin, yMax, data, cancel);
	...
	public static class MojProducer implements IFractalProducer {
		...
		public void produce(double reMin, double reMax, double imMin, double imMax,
			...
			Thread[] radnici = new Thread[this.numThreads];
