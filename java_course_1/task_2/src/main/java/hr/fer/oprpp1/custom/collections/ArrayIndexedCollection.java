...
public class ArrayIndexedCollection implements List {
	...
	private static class ArrayElementsGetter implements ElementsGetter {
		private ArrayIndexedCollection arrayInstance;
		private int currentIndex;
		private long savedModificationCount;
		
		public ArrayElementsGetter(ArrayIndexedCollection arrayInstance) {
		...
		public Object getNextElement() {
			...
			return this.arrayInstance.elements[this.currentIndex++];
