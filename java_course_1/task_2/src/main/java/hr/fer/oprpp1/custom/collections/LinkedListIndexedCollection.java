...
public class LinkedListIndexedCollection implements List {
	...
	public Object get(int index) {
		...
		return this.atIndex(index).value;
	}
	...
	private static class LinkedListElementsGetter implements ElementsGetter {
		...
		private LinkedListIndexedCollection listInstance;
		
		public LinkedListElementsGetter(LinkedListIndexedCollection listInstance) {
		...
		public Object getNextElement() {
			...
			Object toReturn = currentNode.value;
